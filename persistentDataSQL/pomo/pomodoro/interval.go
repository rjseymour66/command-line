...
// Represents the pomodoro interval
...
// Defines the duration for each interval and the data store
...
// Retrieves the last interval from the repository and determines
// the next interval category
